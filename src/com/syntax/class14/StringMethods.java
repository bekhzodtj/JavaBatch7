...
public class StringMethods {
	...
	public static void main(String[] args) {
		...
		// 1st way to create a String literal --> this is the most popular way
		...
		int sizeOfDiffrentString = greetings.length();
		System.out.println(sizeOfDiffrentString);
		...
		//+ with String server as concatenation operator
		//+ with number server as arithmetic operator
		...
		//if length of the String is = 0 --> then it is  Emty
		String str = "Hello";
		boolean isEmty = str.isEmpty();
		...
		//removes space before and after the String
		String cat = "My cat name is Jessy";
		String dog = "     My dog name        Charloy       ";
		System.out.println("------Before Trimming-------");
		System.out.println(cat);
		System.out.println(dog);
		
		System.out.println("-----AfterbTrimming-----------");
